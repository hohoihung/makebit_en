...
namespace makerobo {
    ...
    */
    ...
    //% blockId=robotbit_stop block="Stop the motor|%index|"
    //% weight=80
    ...
    //% blockId=Microbit_Sensor_Sound block="Sound sensor|Pin %pin"
    //% weight=99
    //% blockGap=20
    //% color="#228B22"
    ...
    //% blockId=Microbit_Sensor_IR block="Infrared obstacle avoidance sensor|Pin %pin|value %value"
    //% weight=96
    //% blockGap=20
    //% color="#228B22"
    //% name.fieldEditor="gridpicker" name.fieldOptions.columns=5
